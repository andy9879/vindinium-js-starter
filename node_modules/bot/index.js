...
Bot.prototype.parseTheData = function() {
    return new Promise(function(resolve, reject) {
        ...
        _this.bot1 = {
            ...
            spawnPos: _this.data.game.heroes[0].spawnPos.reverse()
        };
        _this.bot2 = {
            ...
            spawnPos: _this.data.game.heroes[1].spawnPos.reverse()
        };
        _this.bot3 = {
            ...
            spawnPos: _this.data.game.heroes[2].spawnPos.reverse()
        };
        _this.bot4 = {
            ...
            spawnPos: _this.data.game.heroes[3].spawnPos.reverse()
        };
        _this.yourBot = {};
