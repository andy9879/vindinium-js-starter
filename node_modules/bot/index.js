...
Bot.prototype.parseTheData = function() {
    return new Promise(function(resolve, reject) {
        ...
        _this.bot1 = {
            ...
            posArray: [_this.data.game.heroes[0].pos.y, _this.data.game.heroes[0].pos.x],
        ...
        _this.bot2 = {
            ...
            posArray: [_this.data.game.heroes[1].pos.y, _this.data.game.heroes[1].pos.x],
        ...
        _this.bot3 = {
            ...
            posArray: [_this.data.game.heroes[2].pos.y, _this.data.game.heroes[2].pos.x],
        ...
        _this.bot4 = {
            ...
            posArray: [_this.data.game.heroes[3].pos.y, _this.data.game.heroes[3].pos.x],
        ...
        // Adds mines to each of the individual bots
        _this.bot1.mines = _this.bot1mines;
        _this.bot2.mines = _this.bot2mines;
        _this.bot3.mines = _this.bot3mines;
        _this.bot4.mines = _this.bot4mines;
        ...
        console.log("Names/IDs: " +
                    colors.cyan(bot.data.game.heroes[0].name) + colors.green(" ID:" + bot.data.game.heroes[0].id) + " | " +
                    colors.cyan(bot.data.game.heroes[1].name) + colors.green(" ID:" + bot.data.game.heroes[1].id) + " | " +
                    colors.cyan(bot.data.game.heroes[2].name) + colors.green(" ID:" + bot.data.game.heroes[2].id) + " | " +
                    colors.cyan(bot.data.game.heroes[3].name) + colors.green(" ID:" + bot.data.game.heroes[3].id));
